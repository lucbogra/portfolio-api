import { TransitionStatutInvalideError } from 'src/modules/blog/domain/errors/transition-statut-invalide.error.js';
...
const TRANSITIONS_AUTORISES: Record<StatutArticleType, StatutArticleType[]> = {
  [StatutArticleType.BROUILLON]: [
    StatutArticleType.PUBLIE,
    StatutArticleType.INACTIF,
  ],
