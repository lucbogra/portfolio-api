...
import { Contexte, ContexteType } from "src/domain/experience/value-objects/contexte.value-object.js";
...
import { Experience as PrismaExperience, Contexte as PrismaContexte } from "src/generated/prisma/client.js";
...
const DOMAIN_TO_PRISMA_CONTEXTE: Record<ContexteType, PrismaContexte> = {
    ...
    [ContexteType.CONSULTANT]: PrismaContexte.CDD,
    [ContexteType.CDD]: PrismaContexte.CDI
}
